...
func fromTextFloatBody(f *ast.Field, oneofGroup string) string {
	...
	b.WriteString("\t\t\t\t\tvar id_value: String = id_result[\"value\"]\n")
	b.WriteString("\t\t\t\t\tvar id_pos: int = id_result[\"pos\"]\n")
	b.WriteString("\t\t\t\t\tmatch id_value:\n")
	b.WriteString("\t\t\t\t\t\t\"inf\":\n")
	b.WriteString("\t\t\t\t\t\t\tfloat_result = ProtoCoreUtils.NumberParseResult.from_float(INF, id_pos)\n")
	b.WriteString("\t\t\t\t\t\t\"nan\":\n")
	b.WriteString("\t\t\t\t\t\t\tfloat_result = ProtoCoreUtils.NumberParseResult.from_float(NAN, id_pos)\n")
	b.WriteString("\t\t\t\t\t\t_:\n")
