...
func test_self_reference_round_trip():
	...
	var decoded := MessagesLinkedListNode.new()
	expect_equal(decoded.from_bytes(bytes), ProtoCoreUtils.ProtobufError.NO_ERRORS)
